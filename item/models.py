...
class AboutUs(models.Model):
    ...
    thumbnail_image = models.ImageField(upload_to='about/', null=True, blank=True)
...
class ServiceDetail(models.Model):
    ...
    description = models.TextField(null=True, blank=True)
    icon = models.ImageField(upload_to='service_detail/', null=True, blank=True)
...
class WorkTogether(models.Model):
    ...
    description = models.TextField(null=True, blank=True)
    image = models.ImageField(upload_to='together/', null=True, blank=True)
...
class CategoryDetail(models.Model):
    ...
    image = models.ImageField(upload_to='meat/', null=True, blank=True)
...
class QuestionCategory(models.Model):
    name = models.CharField(max_length=100, null=True, blank=True)
    description = models.TextField(null=True, blank=True)
    image = models.ImageField(upload_to='quecategory/', null=True, blank=True)
